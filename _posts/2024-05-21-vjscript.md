...
After chatting with a few more people, I have added some extra info to this page.
...
"This is a full paragraph in VJScript. I am writing this so that others can learn to read it. At first I handwrote my examples. However I recently designed a script in Python to automate the whole process. You can find it below. Thanks for reading this!"
</details>
...
Update: My Twitter friend Daniel B. Gray has written an even better script which accepts ordinary English spelling, converts the words into phonetic transcription using NLP libraries, and then turns that into VJScript. It also has a neat GUI: the link to check it out is [here](https://github.com/danbgray/vjscript)

### Unclear Rules + Areas for Improvement
I didn't clarify how to write dipthongs in the original blog post. Dipthongs are combinations of two vowels (combinations of three vowels are called tripthongs). Some dipthongs received their own unique letters in VJScript, e.g. the "OY" in "boy", but others were left unclarified.
