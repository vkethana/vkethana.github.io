...
The edge image shows significant noise, which is why I had to apply the threshold of 0.20. Anything lower resulted in too much noise entering the image.
The solution is to apply Gaussian smoothing first.
...
For example, here's the edge image generated by the combined filter. It's the same as before!
**Results:**
<p align="center">
