...
The task for this assignment, which is the second to last project of the class, is to implement NeRFs, which are basically a way to synthesize a 3D scene from a set of 2D images.
