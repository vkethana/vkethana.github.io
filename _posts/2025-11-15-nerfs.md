...
and place an object called an ARUCO tag next to them. 
...
Once we have the camera intrinsics and a bunch of photos of our object, 
...
<p align="center">
  <img src="/assets/images/nerf/loss_lego.png" alt="PSNR Curve on LEGO"/>
</p>
...
Here is the best result that I could achieve:
...
<p align="center">
  <img src="/assets/images/nerf/psnr_my_data.png" alt="PSNR Curve for the bucket image"/>
</p>

On the bright side, the model did at least show converge as seen in the below training loss graph:

<p align="center">
  <img src="/assets/images/nerf/loss_my_data.png" alt="PSNR Curve on LEGO"/>
</p>
...
- I downsized my images from 1500 by 2000 to 150 by 200 in order to prevent OOM errors and speed up training
 ...
 - I use a different set of hyperparameters: I set the positional encoding for `X` to have dimension 40 and the positional encoding for `d` to have dimension 15. I chose these experimentally.
...
- the white wall / couch in the background of the image