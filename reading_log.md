...
*   **Hands-on Machine Learning Scikit-Learn, Keras & Tensorflow:**: I can't take Intro to Machine Learning at Berkeley until Spring 2025 at the earliest, so in the meantime I am self-studying these concepts	with this book. I'm more interested in the math behind machine learning architectures than in actually implementing the models. My goal right now is to get a deep, conceptual understanding of ML. Once that's done, I think learning how to actually implement models using Tensorflow / Keras / whatever will come a lot more naturally.
